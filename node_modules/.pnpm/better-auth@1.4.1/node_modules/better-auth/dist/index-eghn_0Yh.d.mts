...
declare const deviceAuthorization: (options?: Partial<DeviceAuthorizationOptions>) => {
  ...
  endpoints: {
    deviceCode: better_call192.StrictEndpoint<"/device/code", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceToken: better_call192.StrictEndpoint<"/device/token", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceVerify: better_call192.StrictEndpoint<"/device", {
      method: "GET";
      query: z.ZodObject<{
    ...
    deviceApprove: better_call192.StrictEndpoint<"/device/approve", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceDeny: better_call192.StrictEndpoint<"/device/deny", {
      method: "POST";
      body: z.ZodObject<{
        userCode: z.ZodString;
      }, z.core.$strip>;
