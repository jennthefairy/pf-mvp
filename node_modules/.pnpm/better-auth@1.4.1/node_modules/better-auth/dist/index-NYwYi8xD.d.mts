import { _ as User, g as Session } from "./index-BzgT8cQd.mjs";
...
declare const anonymous: (options?: AnonymousOptions | undefined) => {
  id: "anonymous";
  endpoints: {
    signInAnonymous: better_call142.StrictEndpoint<"/sign-in/anonymous", {
      method: "POST";
      metadata: {
        openapi: {
          description: string;
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call142.MiddlewareInputContext<better_call142.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  schema: {
    user: {
