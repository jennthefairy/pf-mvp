...
declare const emailOTP: (options: EmailOTPOptions) => {
    ...
    options: {
      emailVerification: {
        sendVerificationEmail(data: {
          user: _better_auth_core_db6.User;
          url: string;
          token: string;
  ...
  endpoints: {
    createVerificationOTP: better_call232.StrictEndpoint<"/email-otp/create-verification-otp", {
      method: "POST";
      body: z.ZodObject<{
        email: z.ZodString;
        type: z.ZodEnum<{
     ...
     */
    getVerificationOTP: better_call232.StrictEndpoint<"/email-otp/get-verification-otp", {
      method: "GET";
      query: z.ZodObject<{
        email: z.ZodString;
        type: z.ZodEnum<{
