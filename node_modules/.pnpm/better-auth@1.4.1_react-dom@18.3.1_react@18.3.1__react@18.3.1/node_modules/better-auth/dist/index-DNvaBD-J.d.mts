...
declare const oAuthProxy: (opts?: OAuthProxyOptions | undefined) => {
  ...
  endpoints: {
    oAuthProxy: better_call147.StrictEndpoint<"/oauth-proxy-callback", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
      ...
      use: ((inputContext: better_call147.MiddlewareInputContext<better_call147.MiddlewareOptions>) => Promise<void>)[];
      metadata: {
        openapi: {
          operationId: string;
          description: string;
