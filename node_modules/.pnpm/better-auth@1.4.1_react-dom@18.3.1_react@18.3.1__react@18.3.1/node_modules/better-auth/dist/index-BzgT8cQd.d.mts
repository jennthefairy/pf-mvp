...
import { n as InferPluginErrorCodes, t as InferOptionSchema } from "./plugins-ClXJF1tD.mjs";
...
import { Account, BetterAuthDBSchema, BetterAuthPluginDBSchema, DBFieldAttribute, DBFieldAttributeConfig, DBFieldType, RateLimit, Session, Session as Session$1, User, User as User$1, Verification } from "@better-auth/core/db";
...
type InferFieldsOutput<Field$1> = Field$1 extends Record<infer Key, DBFieldAttribute> ? { [key in Key as Field$1[key]["required"] extends false ? Field$1[key]["defaultValue"] extends boolean | string | number | Date ? key : never : key]: InferFieldOutput<Field$1[key]> } & { [key in Key as Field$1[key]["returned"] extends false ? never : key]?: InferFieldOutput<Field$1[key]> | null } : {};
...
type InferFieldsFromPlugins<Options extends BetterAuthOptions, Key$1 extends string, Format extends "output" | "input" = "output"> = Options["plugins"] extends [] ? {} : Options["plugins"] extends Array<infer T> ? T extends {
  schema: { [key in Key$1]: {
    fields: infer Field;
  } };
} ? Format extends "output" ? InferFieldsOutput<Field> : InferFieldsInput<Field> : {} : {};
type InferFieldsFromOptions<Options extends BetterAuthOptions, Key$1 extends "session" | "user", Format extends "output" | "input" = "output"> = Options[Key$1] extends {
 ...
 * trustedOrigins.
 */
declare const originCheckMiddleware: (inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<void>;
declare const originCheck: (getValue: (ctx: GenericEndpointContext) => string | string[]) => (inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<void>;
//#endregion
//#region src/api/routes/account.d.ts
declare const listUserAccounts: better_call695.StrictEndpoint<"/list-accounts", {
  method: "GET";
...
declare const unlinkAccount: better_call695.StrictEndpoint<"/unlink-account", {
  method: "POST";
  body: z.ZodObject<{
...
declare const getAccessToken: better_call695.StrictEndpoint<"/get-access-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const refreshToken: better_call695.StrictEndpoint<"/refresh-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const accountInfo: better_call695.StrictEndpoint<"/account-info", {
  method: "GET";
  use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
    session: {
      session: Record<string, any> & {
...
declare const callbackOAuth: better_call695.StrictEndpoint<"/callback/:id", {
  method: ("GET" | "POST")[];
  operationId: string;
...
declare const sendVerificationEmail: better_call695.StrictEndpoint<"/send-verification-email", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    email: z.ZodEmail;
...
declare const verifyEmail: better_call695.StrictEndpoint<"/verify-email", {
  method: "GET";
  operationId: string;
  query: z.ZodObject<{
    token: z.ZodString;
  ...
  use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<void>)[];
  metadata: {
    openapi: {
      description: string;
      parameters: ({
...
declare const ok: better_call695.StrictEndpoint<"/ok", {
  method: "GET";
  metadata: {
    openapi: {
      description: string;
...
declare const requestPasswordReset: better_call695.StrictEndpoint<"/request-password-reset", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    email: z.ZodEmail;
...
declare const requestPasswordResetCallback: better_call695.StrictEndpoint<"/reset-password/:token", {
  method: "GET";
  operationId: string;
  query: z.ZodObject<{
...
declare const resetPassword: better_call695.StrictEndpoint<"/reset-password", {
  method: "POST";
  operationId: string;
  query: z.ZodOptional<z.ZodObject<{
...
declare const getSession: <Option extends BetterAuthOptions>() => better_call695.StrictEndpoint<"/get-session", {
  method: "GET";
  operationId: string;
  query: z.ZodOptional<z.ZodObject<{
 ...
 */
declare const sessionMiddleware: (inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
  session: {
    session: Record<string, any> & {
      id: string;
      createdAt: Date;
 ...
 */
declare const sensitiveSessionMiddleware: (inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
  session: {
    session: Record<string, any> & {
      id: string;
      createdAt: Date;
 ...
 */
declare const requestOnlySessionMiddleware: (inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
  session: {
    session: Record<string, any> & {
      id: string;
      createdAt: Date;
 ...
 * is set to 0
 */
declare const freshSessionMiddleware: (inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
  session: {
    session: Record<string, any> & {
      id: string;
      createdAt: Date;
 ...
 */
declare const listSessions: <Option extends BetterAuthOptions>() => better_call695.StrictEndpoint<"/list-sessions", {
  method: "GET";
  operationId: string;
  use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
    session: {
 ...
 */
declare const revokeSession: better_call695.StrictEndpoint<"/revoke-session", {
  method: "POST";
  body: z.ZodObject<{
    token: z.ZodString;
  }, z.core.$strip>;
 ...
 */
declare const revokeSessions: better_call695.StrictEndpoint<"/revoke-sessions", {
  method: "POST";
  use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
    session: {
      session: Record<string, any> & {
...
declare const revokeOtherSessions: better_call695.StrictEndpoint<"/revoke-other-sessions", {
  method: "POST";
  requireHeaders: true;
  use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
    session: {
...
declare const signInSocial: better_call695.StrictEndpoint<"/sign-in/social", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare const signInEmail: better_call695.StrictEndpoint<"/sign-in/email", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    email: z.ZodString;
...
declare const signOut: better_call695.StrictEndpoint<"/sign-out", {
  method: "POST";
  operationId: string;
  requireHeaders: true;
  metadata: {
...
declare const signUpEmail: <O extends BetterAuthOptions>() => better_call695.StrictEndpoint<"/sign-up/email", {
  method: "POST";
  operationId: string;
...
declare const updateUser: <O extends BetterAuthOptions>() => better_call695.StrictEndpoint<"/update-user", {
  method: "POST";
  operationId: string;
  body: z.ZodRecord<z.ZodString, z.ZodAny>;
  use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
...
declare const changePassword: better_call695.StrictEndpoint<"/change-password", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    newPassword: z.ZodString;
...
declare const setPassword: better_call695.StrictEndpoint<"/set-password", {
  method: "POST";
  body: z.ZodObject<{
    newPassword: z.ZodString;
  }, z.core.$strip>;
...
declare const deleteUser: better_call695.StrictEndpoint<"/delete-user", {
  method: "POST";
  use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
    session: {
      session: Record<string, any> & {
...
declare const deleteUserCallback: better_call695.StrictEndpoint<"/delete-user/callback", {
  method: "GET";
  query: z.ZodObject<{
    token: z.ZodString;
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare const changeEmail: better_call695.StrictEndpoint<"/change-email", {
  method: "POST";
  body: z.ZodObject<{
    newEmail: z.ZodEmail;
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare function getEndpoints<Option extends BetterAuthOptions>(ctx: Promise<AuthContext> | AuthContext, options: Option): {
  api: {
    readonly ok: better_call695.StrictEndpoint<"/ok", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly error: better_call695.StrictEndpoint<"/error", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly signInSocial: better_call695.StrictEndpoint<"/sign-in/social", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        callbackURL: z.ZodOptional<z.ZodString>;
        newUserCallbackURL: z.ZodOptional<z.ZodString>;
        errorCallbackURL: z.ZodOptional<z.ZodString>;
        provider: z.ZodType<"github" | "apple" | "atlassian" | "cognito" | "discord" | "facebook" | "figma" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paybin" | "paypal" | "polar" | (string & {}), unknown, zod_v4_core0.$ZodTypeInternals<"github" | "apple" | "atlassian" | "cognito" | "discord" | "facebook" | "figma" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paybin" | "paypal" | "polar" | (string & {}), unknown>>;
        disableRedirect: z.ZodOptional<z.ZodBoolean>;
        idToken: z.ZodOptional<z.ZodObject<{
          token: z.ZodString;
          nonce: z.ZodOptional<z.ZodString>;
    ...
    readonly callbackOAuth: better_call695.StrictEndpoint<"/callback/:id", {
      method: ("GET" | "POST")[];
      operationId: string;
      body: z.ZodOptional<z.ZodObject<{
        code: z.ZodOptional<z.ZodString>;
    ...
    readonly getSession: better_call695.StrictEndpoint<"/get-session", {
      method: "GET";
      operationId: string;
      query: z.ZodOptional<z.ZodObject<{
        disableCookieCache: z.ZodOptional<z.ZodCoercedBoolean<unknown>>;
    ...
    readonly signOut: better_call695.StrictEndpoint<"/sign-out", {
      method: "POST";
      operationId: string;
      requireHeaders: true;
      metadata: {
    ...
    readonly signUpEmail: better_call695.StrictEndpoint<"/sign-up/email", {
      method: "POST";
      operationId: string;
      body: z.ZodRecord<z.ZodString, z.ZodAny>;
      metadata: {
    ...
    readonly signInEmail: better_call695.StrictEndpoint<"/sign-in/email", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        email: z.ZodString;
    ...
    readonly resetPassword: better_call695.StrictEndpoint<"/reset-password", {
      method: "POST";
      operationId: string;
      query: z.ZodOptional<z.ZodObject<{
        token: z.ZodOptional<z.ZodString>;
    ...
    readonly verifyEmail: better_call695.StrictEndpoint<"/verify-email", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
        token: z.ZodString;
    ...
    readonly sendVerificationEmail: better_call695.StrictEndpoint<"/send-verification-email", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        email: z.ZodEmail;
    ...
    readonly changeEmail: better_call695.StrictEndpoint<"/change-email", {
      method: "POST";
      body: z.ZodObject<{
        newEmail: z.ZodEmail;
        callbackURL: z.ZodOptional<z.ZodString>;
    ...
    readonly changePassword: better_call695.StrictEndpoint<"/change-password", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        newPassword: z.ZodString;
    ...
    readonly setPassword: better_call695.StrictEndpoint<"/set-password", {
      method: "POST";
      body: z.ZodObject<{
        newPassword: z.ZodString;
      }, zod_v4_core0.$strip>;
    ...
    readonly updateUser: better_call695.StrictEndpoint<"/update-user", {
      method: "POST";
      operationId: string;
      body: z.ZodRecord<z.ZodString, z.ZodAny>;
      use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
    ...
    readonly deleteUser: better_call695.StrictEndpoint<"/delete-user", {
      method: "POST";
      use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly requestPasswordReset: better_call695.StrictEndpoint<"/request-password-reset", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        email: z.ZodEmail;
    ...
    readonly requestPasswordResetCallback: better_call695.StrictEndpoint<"/reset-password/:token", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
        callbackURL: z.ZodString;
    ...
    readonly listSessions: better_call695.StrictEndpoint<"/list-sessions", {
      method: "GET";
      operationId: string;
      use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly revokeSession: better_call695.StrictEndpoint<"/revoke-session", {
      method: "POST";
      body: z.ZodObject<{
        token: z.ZodString;
      }, zod_v4_core0.$strip>;
    ...
    readonly revokeSessions: better_call695.StrictEndpoint<"/revoke-sessions", {
      method: "POST";
      use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly revokeOtherSessions: better_call695.StrictEndpoint<"/revoke-other-sessions", {
      method: "POST";
      requireHeaders: true;
      use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly linkSocialAccount: better_call695.StrictEndpoint<"/link-social", {
      method: "POST";
      requireHeaders: true;
      body: z.ZodObject<{
        callbackURL: z.ZodOptional<z.ZodString>;
    ...
    readonly listUserAccounts: better_call695.StrictEndpoint<"/list-accounts", {
      method: "GET";
      use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly deleteUserCallback: better_call695.StrictEndpoint<"/delete-user/callback", {
      method: "GET";
      query: z.ZodObject<{
        token: z.ZodString;
        callbackURL: z.ZodOptional<z.ZodString>;
    ...
    readonly unlinkAccount: better_call695.StrictEndpoint<"/unlink-account", {
      method: "POST";
      body: z.ZodObject<{
        providerId: z.ZodString;
        accountId: z.ZodOptional<z.ZodString>;
    ...
    readonly refreshToken: better_call695.StrictEndpoint<"/refresh-token", {
      method: "POST";
      body: z.ZodObject<{
        providerId: z.ZodString;
        accountId: z.ZodOptional<z.ZodString>;
    ...
    readonly getAccessToken: better_call695.StrictEndpoint<"/get-access-token", {
      method: "POST";
      body: z.ZodObject<{
        providerId: z.ZodString;
        accountId: z.ZodOptional<z.ZodString>;
    ...
    readonly accountInfo: better_call695.StrictEndpoint<"/account-info", {
      method: "GET";
      use: ((inputContext: better_call695.MiddlewareInputContext<better_call695.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
