import { _ as User, g as Session, xt as index_d_exports } from "./index-BzgT8cQd.mjs";
...
declare const jwt: (options?: JwtOptions | undefined) => {
  ...
  endpoints: {
    getJwks: better_call6.StrictEndpoint<"/jwks", {
      method: "GET";
      metadata: {
        openapi: {
          operationId: string;
    ...
    getToken: better_call6.StrictEndpoint<"/token", {
      method: "GET";
      requireHeaders: true;
    ...
    signJWT: better_call6.StrictEndpoint<"/sign-jwt", {
      method: "POST";
      metadata: {
        SERVER_ONLY: true;
        $Infer: {
    ...
    verifyJWT: better_call6.StrictEndpoint<"/verify-jwt", {
      method: "POST";
      metadata: {
        SERVER_ONLY: true;
        $Infer: {
